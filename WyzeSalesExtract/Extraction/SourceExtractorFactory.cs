...
///
/// Register each new client's extractor here as it's built (Edgetec is registered below;
/// Morgenster or whoever follows next) - there's nowhere else in the program that needs to
/// know the list.
/// </summary>
