...
class _PerformanceScreenState extends ConsumerState<PerformanceScreen> {
  ...
  /// every other part of this screen assumes. The additive ACTUAL measures
  /// (actualValue/actualQuantity/actualProfit) are summed exactly like
  /// `_totalsRow`/`_buildExportData` already sum them ACROSS ENTITIES below
  /// — same idea, just across years instead. `gpPercent` is recomputed from
  /// the summed Rand figures rather than averaged — the same "a ratio of
